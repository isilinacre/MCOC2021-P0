...
nombrestxt = ["Corrida_caso_BI_double.txt",
              "Corrida_caso_BII_False_double.txt",
              "Corrida_caso_BII_True_double.txt",
              "Corrida_caso_BIII_False_double.txt",
              "Corrida_caso_BIII_True_double.txt",
              "Corrida_caso_BIV_False_double.txt",
              "Corrida_caso_BIV_True_double.txt",
              "Corrida_caso_BV_False_double.txt",
              "Corrida_caso_BV_True_double.txt"]
...
plt.title("Rendimiento eigh B double") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_caso_B_double_memoria") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
