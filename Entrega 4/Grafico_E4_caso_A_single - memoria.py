...
nombrestxt = ["Corrida_caso_AI_single.txt",
              "Corrida_caso_AII_single.txt",
              "Corrida_caso_AIII_single.txt",
              "Corrida_caso_AIV_single.txt",
              "Corrida_caso_AV_single.txt",
              "Corrida_caso_AVI_single.txt",
              "Corrida_caso_AVII_single.txt"]
...
plt.title("Rendimiento Solve A single") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_caso_A_single_memoria") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
