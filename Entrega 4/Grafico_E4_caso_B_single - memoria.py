...
nombrestxt = ["Corrida_caso_BI_single.txt",
              "Corrida_caso_BII_False_single.txt",
              "Corrida_caso_BII_True_single.txt",
              "Corrida_caso_BIII_False_single.txt",
              "Corrida_caso_BIII_True_single.txt",
              "Corrida_caso_BIV_False_single.txt",
              "Corrida_caso_BIV_True_single.txt",
              "Corrida_caso_BV_False_single.txt",
              "Corrida_caso_BV_True_single.txt"]
...
plt.title("Rendimiento eigh B single") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_caso_B_single_memoria") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
