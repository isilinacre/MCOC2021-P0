...
for i in range(NCOR): #recorro la cantidad de numero de corridas 
    fin = f"corrida_{i}_matrizllena.txt" #recorro el archivo de texto i creado por timing_matmul  
...
plt.title("Rendimiento MATMUL matriz llena") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico matriz llena") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
