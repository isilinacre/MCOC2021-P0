...
fid = open("Corrida_Scipy_single.txt", "w") #abro el archivo creado
...
print(f"Uso memoria Scipy - dtype single: {bytes_total}")
print(f"Tiempo de inversión Scipy - dtype single: {dt_inversion} (s)")