...
with open("Corrida_Scipy_half.txt") as f:
...
plt.title("Rendimiento INVERSA - dtype half") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_dtype_half") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
