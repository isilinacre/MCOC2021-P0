...
fid = open("Corrida_Scipy_half.txt", "w") #abro el archivo creado
...
print(f"Uso memoria Scipy - dtype half: {bytes_total}")
print(f"Tiempo de inversión Scipy - dtype half: {dt_inversion} (s)")