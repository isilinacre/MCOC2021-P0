...
with open("Corrida_Numpy_double.txt") as f:
...
plt.title("Rendimiento INVERSA - dtype double") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_dtype_double") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
