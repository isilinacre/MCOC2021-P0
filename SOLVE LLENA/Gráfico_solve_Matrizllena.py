...
for i in range(NCOR): #recorro la cantidad de numero de corridas 
    fin = f"corrida_{i}_solve_matrizllena.txt" #recorro el archivo de texto i creado por timing_matmul  
...
plt.title("Rendimiento solve Matriz Llena") #le escribo el titulo principal a mis graficos
...
plt.savefig("Grafico_solve_Matrizllena") #se guarda la foto del grafico en la carpeta donde se está corriendo este programa
